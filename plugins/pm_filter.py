    ...
    if query.data.startswith("file"):
        ...
        buttons = [
            [
                ...
                InlineKeyboardButton('Channel ⭕️', url='https://t.me/allnewmovies112')
            ],
            [
                InlineKeyboardButton('🎬 Series & Movie Club 🎬', url=f'https://t.me/allnewmoviessupport')
            ]
            ]
        ...
        buttons = [[
            ...
            InlineKeyboardButton('⭕️ Updates', url='https://t.me/allnewmoviessupport'),
        ...
        buttons = [[
            InlineKeyboardButton('⭕ Status', url='https://t.me/allnewmovies112'),
...
async def auto_filter(client, msg, spoll=False):
    ...
    btn.insert(0, [
        InlineKeyboardButton("⭕️ Movie Group", url="https://t.me/allnewmovies112"),
        InlineKeyboardButton("Movie Group ⭕️", url="https://t.me/allnewmoviessupport")
    ])
    btn.insert(0, [
        InlineKeyboardButton("⭕️ Join Our Channel ⭕️",url="@allnewmovies112")
    ])
